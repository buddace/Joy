...
/* HID */
#define HID_INTF_ID0             	0x00
#define HID_EP0 					1
#define HID_INT_OUT_EP_SIZE0     	3
#define HID_INT_IN_EP_SIZE0      	8
#define HID_NUM_OF_DSC0          	1
#define HID_RPT01_SIZE0          	74

#define HID_INTF_ID1             	0x01
#define HID_EP1 					2
#define HID_INT_OUT_EP_SIZE1     	3
#define HID_INT_IN_EP_SIZE1      	8
#define HID_NUM_OF_DSC1          	1
#define HID_RPT01_SIZE1          	74

#define HID_INTF_ID2             	0x02
#define HID_EP2 					3
#define HID_INT_OUT_EP_SIZE2     	3
#define HID_INT_IN_EP_SIZE2      	8
#define HID_NUM_OF_DSC2          	1
#define HID_RPT01_SIZE2          	49

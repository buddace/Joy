...
// Can provide compile time option to do software pingpong
    ...
    volatile unsigned char hid_report_out0[HID_INT_OUT_EP_SIZE0];
    volatile unsigned char hid_report_in0[HID_INT_IN_EP_SIZE0];
    volatile unsigned char hid_report_out1[HID_INT_OUT_EP_SIZE1];
    volatile unsigned char hid_report_in1[HID_INT_IN_EP_SIZE1];
	volatile unsigned char hid_report_out2[HID_INT_OUT_EP_SIZE2];
	volatile unsigned char hid_report_in2[HID_INT_IN_EP_SIZE2];
#endif

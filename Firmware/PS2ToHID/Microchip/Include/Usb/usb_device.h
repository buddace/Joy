...
/** EXTERNS ********************************************************/
    ...
    //Class specific - HID report descriptor
        ...
        extern ROM struct{BYTE report[HID_RPT01_SIZE0];} hid_rpt01;
        extern ROM struct{BYTE report[HID_RPT01_SIZE0];} hid_rpt02;
    #endif
    #endif
    ...
    extern volatile unsigned char hid_report_out0[HID_INT_OUT_EP_SIZE0];
    extern volatile unsigned char hid_report_in0[HID_INT_IN_EP_SIZE0];
    extern volatile unsigned char hid_report_out1[HID_INT_OUT_EP_SIZE1];
    extern volatile unsigned char hid_report_in1[HID_INT_IN_EP_SIZE1];
    extern volatile unsigned char hid_report_out2[HID_INT_OUT_EP_SIZE2];
    extern volatile unsigned char hid_report_in2[HID_INT_IN_EP_SIZE2];
    #endif
